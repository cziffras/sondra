...
def get_augment_transform(data_config):
    # transform_args = data_config.get("transform", {})

    # transform_name = transform_args.get("name", "RandomSARTransform")
    # transform_params = transform_args.get("params", {})

    return (lambda x: x) #eval(f"{transform_name}")(**transform_params)


def get_contrastive_transform(data_config):
    transform_args = data_config.get("transform", {})
...
def get_polsf_dataloaders(
    ...
    if contrastive:
        ...
        transform = get_contrastive_transform(data_config=data_config)
    ...
    if not contrastive:
        ...
        transform = get_augment_transform(data_config)
